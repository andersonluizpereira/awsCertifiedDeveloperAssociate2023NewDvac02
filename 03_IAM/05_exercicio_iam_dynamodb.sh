...
aws --endpoint-url=http://localhost:4566 iam attach-user-policy --user-name MeuNovoUsuario --policy-arn arn:aws:iam::SuaConta:policy/DynamoDBFullAccess
...
aws --endpoint-url=http://localhost:4566 iam attach-group-policy --group-name MeuNovoGrupo --policy-arn arn:aws:iam::SuaConta:policy/DynamoDBFullAccess